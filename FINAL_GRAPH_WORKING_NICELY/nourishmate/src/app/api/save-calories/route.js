...
export async function POST(request) {
  try {
    ...
    const { bmr, tdee, targetCalories } = await request.json();
    console.log("Caloric data received:", { bmr, tdee, targetCalories });
    ...
    console.log("Caloric data updated successfully.");
    return new Response(
